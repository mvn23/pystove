...
from .pystove import (
    ...
    DATA_END_HOUR,
    DATA_END_MINUTE,
    DATA_FIRMWARE_VERSION,
    DATA_FIRMWARE_VERSION_BUILD,
    DATA_FIRMWARE_VERSION_MAJOR,
    DATA_FIRMWARE_VERSION_MINOR,
    DATA_HOURS,
    DATA_MAINTENANCE_ALARMS,
    DATA_MESSAGE_ID,
    DATA_MINUTES,
    DATA_MONTH,
    DATA_NEW_FIREWOOD_ESTIMATE,
    DATA_NEW_FIREWOOD_HOURS,
    DATA_NEW_FIREWOOD_MINUTES,
    DATA_NIGHT_BEGIN_HOUR,
    DATA_NIGHT_BEGIN_MINUTE,
    DATA_NIGHT_BEGIN_TIME,
    DATA_NIGHT_END_HOUR,
    DATA_NIGHT_END_MINUTE,
    DATA_NIGHT_END_TIME,
    DATA_NIGHT_LOWERING,
    DATA_OPERATION_MODE,
    DATA_OXYGEN_LEVEL,
    ...
    DATA_REMOTE_VERSION,
    DATA_REMOTE_VERSION_BUILD,
    DATA_REMOTE_VERSION_MAJOR,
    DATA_REMOTE_VERSION_MINOR,
    ...
    DATA_TEST_VALVE2,
    DATA_TEST_VALVE3,
    DATA_TIME_SINCE_REMOTE_MSG,
    DATA_TIME_TO_NEW_FIREWOOD,
    DATA_UPDATING,
